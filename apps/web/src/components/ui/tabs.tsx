...
const tabsListVariants = cva(
  "rounded-xl p-[3px] group-data-horizontal/tabs:h-8 data-[variant=line]:rounded-xl group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default: "bg-muted",
